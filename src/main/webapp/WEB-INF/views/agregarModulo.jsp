...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear m&oacute;dulo</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Diligencie los datos del m&oacute;dulo</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO AGREGAR MODULO-->
								<div id="fields">
									  <c:url value="/rAgregarModulo" var="formUrl"/>
