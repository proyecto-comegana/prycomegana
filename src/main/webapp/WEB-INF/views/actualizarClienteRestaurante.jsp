...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina busqueda actualizar cliente restaurante</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del cliente y el restaurante</h2>
				<p>Buscar datos para actualizar cliente y el restaurante</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO BUSQUEDA ACTUALIZAR CLIENTE Y RESTAURANTE-->
								<div id="fields">
									  <c:url value="/rActualizarClienteRestaurante" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDA ACTUALIZAR CLIENTE Y RESTAURANTE</legend>
          									<table>
              									<tr>
