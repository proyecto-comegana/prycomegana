...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina actualizar ciudad</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> estad&iacute;sticos</h2>
				<p>Diligencie los parametros de la consulta</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
												...
												<tr>
              									<tr>
	             									<td><form:label path="sNombreRecurso">Nombre del recurso:</form:label></td> 
                  									<td>
                  										<form:select path="sNombreRecurso" style="min-width:765px;height:37px;">
              											<form:option value="NONE" selected="selected" label="Seleccione una opción"/>
              											<form:options items="${lstRecursos}"/>
														</form:select>
              										</td>
              									</tr>
              									<tr>
...
<%
    ...
    //CONSULTA PARAMETRO numregxpag        
    String sql = "select valor from parametro where nombre = ?";
    PreparedStatement ps = null;
	ps = cone.prepareStatement(sql);
    ps.setString(1, "numregxpag");
    ResultSet rs = ps.executeQuery();
	Integer numregxpag = new Integer(0);

	if (rs.next()){
    	numregxpag = rs.getInt(1);
    	System.out.println("# registros x página: " + numregxpag);
    }
	
	s.setAttribute("numregxpag", numregxpag);
	Integer iInicio = new Integer(1);
	s.setAttribute("iInicio", iInicio);
	Integer iFin = new Integer(10);
	s.setAttribute("iFin", iFin);
	Integer iCuenta = new Integer(0);
	s.setAttribute("iCuenta", iCuenta);
%>
</body>
</html>