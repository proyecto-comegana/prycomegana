...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina busqueda actualizar la recarga y la tar&iacute;fa</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> de recarga y tar&iacute;fa</h2>
				<p>Buscar datos para actualizar recarga y tar&iacute;fa</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO BUSQUEDA ACTUALIZAR RECARGA Y TARIFA -->
								<div id="fields">
									  <c:url value="/rActualizarRecargaTarifa" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDA ACTUALIZAR RECARGA Y TARIFA</legend>
          									<table>
              									<tr>
