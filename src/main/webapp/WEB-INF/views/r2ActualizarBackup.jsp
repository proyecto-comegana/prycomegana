...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina respuesta actualizar backup</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Visualizaci&oacute;n de los datos del backup</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
...
<%
	session.removeAttribute("codigo_backup");
	session.removeAttribute("descrip_backup");
	session.removeAttribute("tipo_backup");
	session.removeAttribute("archivo_backup");
	session.removeAttribute("ruta_backup");
	session.removeAttribute("fecha_backup");
	session.removeAttribute("hora_backup");
