...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina resultados consultar cliente y sucesor</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del cliente y sucesor</h2>
				<p>Informaci&oacute;n  del cliente y el sucesor</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR CLIENTE Y SUCESOR -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR CLIENTE Y SUCESOR</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lCliente">Cliente: </form:label></td>
                  									<td><form:input size="110" path="lCliente" value="${cliente_clientesucesor}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lSucesor">Descripci&iacute;n: </form:label></td>
                  									<td><form:input size="110" path="lSucesor" value="${sucesor_clientesucesor}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_clientesucesor}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_clientesucesor}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
...
<%
	session.removeAttribute("cliente_clientesucesor");
	session.removeAttribute("sucesor_clientesucesor");
	session.removeAttribute("fecha_clientesucesor");
	session.removeAttribute("hora_clientesucesor");
%> 
</body>
</html>