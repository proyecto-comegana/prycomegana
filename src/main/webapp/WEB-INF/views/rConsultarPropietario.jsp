...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar propietario</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del propietario</h2>
				<p>Informaci&oacute;n  del propietario</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR CONVENIO -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR PROPIETARIO</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lCedula">C&eacute;dula: </form:label></td>
                  									<td><form:input size="110" path="lCedula" value="${cedula_propietario}"/></td>
              									</tr>
				
              									<tr>
	             									<td><form:label path="lRestaurante">Restaurante: </form:label></td>
                  									<td><form:input size="110" path="lRestaurante" value="${rest_propietario}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sEstado">Estado: </form:label></td>
                  									<td><form:input size="110" path="sEstado" value="${estado_propietario}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lPersona">Persona: </form:label></td>
                  									<td><form:input size="110" path="lPersona" value="${persona_propietario}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_propietario}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_propietario}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
...
<%
	session.removeAttribute("cedula_propietario");
	session.removeAttribute("rest_propietario");
	session.removeAttribute("estado_propietario");
	session.removeAttribute("persona_propietario");
	session.removeAttribute("fecha_propietario");
	session.removeAttribute("hora_propietario");
%>
</body>
</html>