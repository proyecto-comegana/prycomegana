				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
									  <c:url value="/rEstad_Diario" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO CONSULTAR ESTADISTICA DIARIA</legend>
          									<table>
												<tr>
              									<tr>
	             									<td><form:label path="sNombreRecurso">Nombre del recurso: </form:label></td>
                  									<td><form:input size="110" path="sNombreRecurso" /></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" /></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
