...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar backup</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del backup</h2>
				<p>Informaci&oacute;n  del backup</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR BACKUP-->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR BACKUP</legend>
          									<table>
              									<tr>
	             									<td><form:label path="iCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="iCodigo" value="${codigo_backup}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sDescripcion">Descripci&oacute;n: </form:label></td>
                  									<td><form:input size="110" path="sDescripcion" value="${descrip_backup}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iTipo">Tipo: </form:label></td>
                  									<td><form:input size="110" path="iTipo" value="${tipo_backup}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sNombreArchivo">Archivo: </form:label></td>
                  									<td><form:input size="110" path="sNombreArchivo" value="${archivo_backup}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sRutaArchivo">Ruta: </form:label></td>
                  									<td><form:input size="110" path="sRutaArchivo" value="${ruta_backup}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_backup}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_backup}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
