...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina agregar propietario</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Diligencie los datos del propietario</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
									  <c:url value="/rAgregarPropietario" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
          									...
          									<table>
              									...
              									<tr>
                  									...
                  									<td><form:input size="110" path="lRestaurante" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sEstado">Estado: </form:label></td>
                  									<td><form:input size="110" path="sEstado" /></td>
              									</tr>
              									<tr>
