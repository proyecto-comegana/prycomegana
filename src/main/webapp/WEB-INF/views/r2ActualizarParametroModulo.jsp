	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Respuesta actualizaci&oacute;n del par&aacute;metro y modulo</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
...
<%
	session.removeAttribute("parametro_paramod");
	session.removeAttribute("modulo_paramod");
	session.removeAttribute("fecha_paramod");
	session.removeAttribute("hora_paramod");
