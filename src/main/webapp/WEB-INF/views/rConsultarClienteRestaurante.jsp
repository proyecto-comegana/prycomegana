...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina resultados consultar cliente y restaurante</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del cliente y restaurante</h2>
				<p>Informaci&oacute;n  del cliente y del restaurante</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR CLIENTE Y RESTAURANTE -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR CLIENTE Y RESTAURANTE</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lCliente">Cliente: </form:label></td>
                  									<td><form:input size="110" path="lCliente" value="${cliente_clienterest}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lRestaurante">Restaurante: </form:label></td>
                  									<td><form:input size="110" path="lRestaurante" value="${restaurante_clienterest}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_clienterest}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_clienterest}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
...
<%
	session.removeAttribute("cliente_clienterest");
	session.removeAttribute("restaurante_clienterest");
	session.removeAttribute("fecha_clienterest");
	session.removeAttribute("hora_clienterest");
%> 
</body>
</html>