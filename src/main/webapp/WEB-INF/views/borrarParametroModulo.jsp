...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina busqueda borrar par&aacute;metro y modulo</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Buscar datos para borrar par&aacute;metro y modulo</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO BUSQUEDA BORRAR PARAMETRO Y MODULO-->
								<div id="fields">
									  <c:url value="/rBorrarParametroModulo" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDA PARA BORRAR PARAMETRO Y MODULO</legend>
          									<table>
              									<tr>
