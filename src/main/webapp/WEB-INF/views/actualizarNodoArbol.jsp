...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina busqueda actualizar nodo y &aacute;rbol</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del nodo y el &aacute;arbol</h2>
				<p>Buscar datos para actualizar nodo y el &aacute;arbol</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO BUSQUEDA ACTUALIZAR NODO Y EL ARBOL -->
								<div id="fields">
									  <c:url value="/rActualizarNodoArbol" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDA ACTUALIZAR NODO Y EL ARBOL</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lNodo">Nodo: </form:label></td>
                  									<td><form:input size="110" path="lNodo" /></td>
              									</tr>
              									<tr>
