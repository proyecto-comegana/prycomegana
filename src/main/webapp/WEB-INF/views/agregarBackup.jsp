...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear backup</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Diligencie los datos del backup</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
								      ...
								      <form:form class="clearfix" method="GET" action="${formUrl}">
      									...
      									<br><br> 
       									<c:url value="/recuperacion" var="formUrl"/>
										<table>				
						      				<form:form class="clearfix" method="GET" action="${formUrl}">
		                					<tr>
		                						<td width=395>
		                							Presione este bot&oacute;n para restaurar una base de datos:
		                						</td>
		                						<td>
		                							<input type="submit" value="Restaurar" class="btn btn-primary btn-lg"/>
												</td>
		                						</form:form>
		                					</tr>
            							</table>
