...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina empleado</title>
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO BUSQUEDA CONSULTAR EMPLEADO -->
								<div id="fields">
									  <c:url value="/rConsultarEmpledo" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDA CONSULTAR EMPLEADO</legend>
          									<table>
												<TR>
              									<tr>
