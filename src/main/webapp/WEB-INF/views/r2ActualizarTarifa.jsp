...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina actualizar tar&iacute;fa</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Respuesta actualizaci&oacute;n de la tar&iacute;fa</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
...
<%
	session.removeAttribute("codigo_tarifa");
	session.removeAttribute("descrip_tarifa");
	session.removeAttribute("valor_tarifa");
	session.removeAttribute("fecha_tarifa");
	session.removeAttribute("hora_tarifa");
%>
</body>
</html>