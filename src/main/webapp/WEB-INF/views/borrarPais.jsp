				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
									  <c:url value="/rBorrarPais" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BORRAR PAIS</legend>
          									<table>
												<TR>
              									<tr>
	             									<td><form:label path="iCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="iCodigo" /></td>
              									</tr>
              									<tr>
              									...
              									<tr>
                  									...
                  									<td><form:input size="110" path="sHora"/></td>
              									</tr>
              									<tr>          
              									<tr align="center">
                  									<td colspan="2">
                  										<input type="submit" value="Borrar" class="btn btn-primary btn-lg"/>
