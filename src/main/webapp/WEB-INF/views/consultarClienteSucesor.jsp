...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar cliente y sucesor</title>
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR CLIENTE Y EL SUCESOR-->
								<div id="fields">
									  <c:url value="/rConsultarClienteSucesor" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDAR PARA CONSULTAR CLIENTE Y SUCESOR</legend>
          									<table>
              									<tr>
