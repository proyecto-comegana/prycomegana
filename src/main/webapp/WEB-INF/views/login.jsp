...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina iniciar sesi&oacute;n</title>
	...
	<div id="page" class="single_page">
							...
							<ul><c:url value="blog"/>
								...
								<li class="sub-menu active">
									...
									<ul>
										...
										<li><a href="<c:url value="portfolio-post"/>">Portafolio Trabajo Individual</a></li>
									</ul>
								</li>
							</ul>
						</nav>
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Iniciar</b> la sesi&oacute;n</h2>
				<p>Introduce el nombre y contrase&nacute;a para darse de alta en nuestra aplicaci&oacute;n COMEGANA.</p>
			</div>
		</section><!-- //BREADCRUMBS -->
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
									<br>
									<br>
									  <c:url value="/redireccionar" var="formUrl"/>
								      <form class="clearfix" id="contact-form-face" method="get" action="${formUrl}">
											<legend><b>Formulario inicio de sesi&oacute;n</b></legend>
											<input type="text" name="sNombreUsuario" path="sNombreUsuario" value="Nombre de usuario" onFocus="if (this.value == 'Nombre de usuario') this.value = '';" onBlur="if (this.value == '') this.value = 'Nombre de usuario';" />
											<br>
											<input type="password" size="115" border=4 style="height:38px" name="sContrasena" path="sContrasena" value="Contrase&nacute;a" onFocus="if (this.value == 'Contrase&nacute;a') this.value = '';" onBlur="if (this.value == '') this.value = 'Contrase&nacute;a';" />
											<br><br>
											<input type="password" size="115" style="height:38px;" name="recontrase" value="contrase&nacute;a" onFocus="if (this.value == 'contrase&nacute;a') this.value = '';" onBlur="if (this.value == '') this.value = 'Repetir contrase&nacute;a';" />
											<br><br>
											<input class="contact_btn" type="submit" value="Darse de alta" />
										</form>
								</div>
