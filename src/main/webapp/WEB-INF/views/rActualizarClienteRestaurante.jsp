...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina actualizar cliente y restaurante</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del cliente y del restaurante</h2>
				<p>Actualice los datos del cliente y del restaurante</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CLIENTE RESTAURANTE -->
								<div id="fields">
								      <c:url value="/r2ActualizarClienteRestaurante" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO ACTUALIZAR CLIENTE Y RESTAURANTE</legend>
          									<table>
              									<tr>
              									...
              									<tr>
	             									<td><form:label path="lRestaurante">Premio: </form:label></td>
