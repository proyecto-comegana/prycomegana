...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear cliente y sucesor</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del cliente y el sucesor</h2>
				<p>Diligencie los datos del cliente y el sucesor</p>
			</div>
		</section><!-- //BREADCRUMBS -->
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
									  <c:url value="/rAgregarClienteSucesor" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>DATOS CLIENTE Y SUCESOR</legend>
          									<table>
              									<tr>
              									...
              									<tr>
                  									...
                  									<td><form:input size="110" path="lSucesor" /></td>
              									</tr>
              									<tr>
