...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina actualizar nodo &aacute;rbol</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Respuesta actualizaci&oacute;n del nodo y el &aacute;rbol</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
...
<%
	session.removeAttribute("nodo_nodoarbol");
	session.removeAttribute("arbol_nodoarbol");
	session.removeAttribute("fecha_nodoarbol");
	session.removeAttribute("hora_nodoarbol");
