	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Registro</b> de usuarios</h2>
				<p>Diligencie los datos b&aacute;sicos y espec&iacute;ficos de la persona.</p>
			</div>
		</section><!-- //BREADCRUMBS -->
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
								      <form:form class="clearfix" method="POST" action="datos_propietario">
								      		<legend>DATOS BASICOS DE LA PERSONA</legend>
          									<table>
              									<tr>
                  									<td><form:label path="lIdPersona">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="lIdPersona" /></td>
              									</tr>
              									<tr>
              									...
              									<tr>
                  									...
                  									<td><form:input size="110" path="sCorreo" value="@"/></td>
              									</tr>            
              									<tr>
                  									<td><form:label path="sFecha_Nac">Fecha nacimiento: </form:label></td>
                  									<td><form:input path="sFecha_Nac"/></td>
              									</tr> 
              									<tr>           
              									<tr align="center">
                  									<td colspan="2">
                  										<input type="submit" value="Siguiente" class="btn btn-primary btn-lg"/>
					...
					<div class="sidebar col-lg-3 col-md-3 padbot50">
						...
						<div class="sidepanel widget_meta">
							<ul>
								...
								<li><a href="javascript:void(0);" >Tendencias de la moda</a></li>
								<li><a href="javascript:void(0);" >Proyectos de medios</a></li>
								<li><a href="javascript:void(0);" >Pequeños negocios</a></li>
