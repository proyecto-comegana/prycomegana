...
<title>Grafico estadisticas ip</title>
</head>
<body>
<%
	...
	*/
	...
	try{
		...
		JFreeChart chart = ChartFactory.createBarChart3D("Accesos por ips ("+ rec + ", " + fec +")", "Dirección ip", "Puntaje", data, PlotOrientation.HORIZONTAL, false, true, false);
