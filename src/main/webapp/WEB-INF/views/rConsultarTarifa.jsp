...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar tar&iacute;fa</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> de la tar&iacute;fa</h2>
				<p>Informaci&oacute;n  de la tar&iacute;fa</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR TARIFA -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR TARIFA</legend>
          									<table>
              									<tr>
	             									<td><form:label path="iCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="iCodigo" value="${codigo_tarifa}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sDescripcion">Descripci&iacute;n: </form:label></td>
                  									<td><form:input size="110" path="sDescripcion" value="${descrip_tarifa}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lValor">Valor: </form:label></td>
                  									<td><form:input size="110" path="lValor" value="${valor_tarifa}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_tarifa}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_tarifa}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
