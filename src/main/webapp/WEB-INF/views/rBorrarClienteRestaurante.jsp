...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina borrar cliente y restaurante</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Respuesta eliminaci&oacute;n del cliente y el restaurante</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- RESPUESTA ELIMINAR CLIENTE Y EL RESTAURANTE -->
								<div id="fields">
									<h1>${mensaje}</h1>
								</div>
							</div>
