...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar acceso</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del acceso</h2>
				<p>Informaci&oacute;n  del acceso</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR ACCESO-->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR ACCESO</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="lCodigo" value="${codigo_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sIP">Direcci&oacute;n IP: </form:label></td>
                  									<td><form:input size="110" path="sIP" value="${ip_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="iModulo">Modulo: </form:label></td>
                  									<td><form:input size="110" path="iModulo" value="${modulo_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sPagina">P&aacute;gina: </form:label></td>
                  									<td><form:input size="110" path="sPagina" value="${pagina_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sObjeto">Objeto: </form:label></td>
                  									<td><form:input size="110" path="sObjeto" value="${objeto_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sTabla">Tabla: </form:label></td>
                  									<td><form:input size="110" path="sTabla" value="${tabla_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sOperacion">Operaci&oacute;n: </form:label></td>
                  									<td><form:input size="110" path="sOperacion" value="${operacion_acceso}" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sAccion">Accion: </form:label></td>
                  									<td><form:input size="110" path="sAccion" value="${accion_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sProceso">Proceso: </form:label></td>
                  									<td><form:input size="110" path="sProceso" value="${proceso_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sEstadoTarea">Estado tar&eacute;a: </form:label></td>
                  									<td><form:input size="110" path="sEstadoTarea" value="${estadotarea_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sComando">Comando: </form:label></td>
                  									<td><form:input size="110" path="sComando" value="${comando_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sAplicacion">Aplicaci&oacute;n: </form:label></td>
                  									<td><form:input size="110" path="sAplicacion" value="${aplicacion_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="iTiempo">Tiempo: </form:label></td>
                  									<td><form:input size="110" path="iTiempo" value="${tiempo_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sTransaccion">Transacci&oacute;n: </form:label></td>
                  									<td><form:input size="110" path="sTransaccion" value="${transaccion_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_acceso}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="lUsuario">Usuario: </form:label></td>
                  									<td><form:input size="110" path="lUsuario" value="${usuario_acceso}"/></td>
              									</tr>
											</table>
      									</form:form>
								</div>
...
<%
	session.removeAttribute("codigo_parametro");
	session.removeAttribute("nombre_parametro");
	session.removeAttribute("descrip_parametro");
	session.removeAttribute("valor_parametro");
	session.removeAttribute("tipo_parametro");
	session.removeAttribute("modulo_parametro");
	session.removeAttribute("fecha_parametro");
	session.removeAttribute("hora_parametro");
%>
</body>
</html>