...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina busqueda borrar cliente y restaurante</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Buscar datos para borrar cliente y el restaurante</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO BUSQUEDA BORRAR CLIENTE Y RESTAURANTE -->
								<div id="fields">
									  <c:url value="/rBorrarClienteRestaurante" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDA PARA BORRAR CLIENTE Y RESTAURANTE</legend>
          									<table>
              									<tr>
