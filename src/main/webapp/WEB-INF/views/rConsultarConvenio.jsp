...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar convenio</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> de convenio</h2>
				<p>Informaci&oacute;n  del convenio</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR CONVENIO</legend>
          									<table>
              									<tr>
	             									<td><form:label path="iCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="iCodigo" value="${codigo_convenio}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sDescripcion">Descripci&oacute;n: </form:label></td>
                  									<td><form:input size="110" path="sDescripcion" value="${descrip_convenio}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_convenio}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_convenio}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
