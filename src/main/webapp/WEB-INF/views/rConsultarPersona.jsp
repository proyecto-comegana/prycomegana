...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar persona</title>
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR PERSONA -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR PERSONA</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lPersona">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="lPersona" value="${codigo_persona}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sNombres">Nombres: </form:label></td>
                  									<td><form:input size="110" path="sNombres" value="${nombre_persona}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sApellidos">Apellidos: </form:label></td>
                  									<td><form:input size="110" path="sApellidos" value="${apel_persona}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sDireccion">Direcci&oacute;n: </form:label></td>
                  									<td><form:input size="110" path="sDireccion" value="${dir_persona}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sTelefono">Tel&eacute;fono: </form:label></td>
                  									<td><form:input size="110" path="sTelefono" value="${tel_persona}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sCorreo">Correo: </form:label></td>
                  									<td><form:input size="110" path="sCorreo" value="${correo_persona}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sFecha_Nac">Fecha de nacimiento: </form:label></td>
                  									<td><form:input size="110" path="sFecha_Nac" value="${fnac_persona}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sSexo">Sexo: </form:label></td>
                  									<td><form:input size="110" path="sSexo" value="${sexo_persona}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="iCiudad">Ciudad: </form:label></td>
                  									<td><form:input size="110" path="iCiudad" value="${ciudad_persona}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_persona}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_persona}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
