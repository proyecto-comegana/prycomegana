...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina bonificaciones</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> de la bonificaci&oacute;n</h2>
				<p>Informaci&oacute;n  de la bonificaci&oacute;n</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR BONIFICACION</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="lCodigo" value="${codigo_bonificacion}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lCliente">Cliente: </form:label></td>
                  									<td><form:input size="110" path="lCliente" value="${cliente_bonificacion}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lValor">Valor: </form:label></td>
                  									<td><form:input size="110" path="lValor" value="${valor_bonificacion}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_bonificacion}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_bonificacion}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
...
<%
	session.removeAttribute("codigo_bonificacion");
	session.removeAttribute("cliente_bonificacion");
	session.removeAttribute("valor_bonificacion");
	session.removeAttribute("fecha_bonificacion");
	session.removeAttribute("hora_bonificacion");
%>
</body>
</html>