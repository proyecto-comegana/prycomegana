...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear cliente y restaurante</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Diligencie los datos del cliente y el restaurante</p>
			</div>
		</section><!-- //BREADCRUMBS -->
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO AGREGAR CLIENTE Y PREMIO -->
								<div id="fields">
									  <c:url value="/rAgregarClienteRestaurante" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>DATOS CLIENTE Y RESTAURANTE</legend>
          									<table>
              									<tr>
