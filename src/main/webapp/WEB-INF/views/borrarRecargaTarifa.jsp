...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina busqueda borrar recarga y tar&iacute;fa</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Buscar datos para borrar recarga y tar&iacute;fa</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO BUSQUEDA BORRAR RECARGA Y TARIFA-->
								<div id="fields">
									  <c:url value="/rBorrarRecargaTarifa" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDA PARA RECARGA Y TARIFA</legend>
          									<table>
              									<tr>
