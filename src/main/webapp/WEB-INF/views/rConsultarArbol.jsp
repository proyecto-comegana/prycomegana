...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar &aacute;rbol</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del &aacute;rbol</h2>
				<p>Informaci&oacute;n  del &aacute;rbol</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR ARBOL-->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR ARBOL</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="lCodigo" value="${codigo_arbol}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iNiveles">Niveles: </form:label></td>
                  									<td><form:input size="110" path="iNiveles" value="${niveles_arbol}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iElementos">Elementos: </form:label></td>
                  									<td><form:input size="110" path="iElementos" value="${elementos_arbol}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_arbol}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_arbol}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="lCliente">Cliente: </form:label></td>
                  									<td><form:input size="110" path="lCliente" value="${cliente_arbol}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="iCupos">Cupos: </form:label></td>
                  									<td><form:input size="110" path="iCupos" value="${cupos_arbol}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
...
<%
	session.removeAttribute("codigo_arbol");
	session.removeAttribute("niveles_arbol");
	session.removeAttribute("elementos_arbol");
