...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina restaurante</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Respuesta actualizaci&oacute;n restaurante</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
...
<%
	session.removeAttribute("codigo_restaurante");
	session.removeAttribute("nombre_restaurante");
	session.removeAttribute("descrip_restaurante");
	session.removeAttribute("telefono_restaurante");
	session.removeAttribute("propietario_propietario");
	session.removeAttribute("convenio_propietario");
	session.removeAttribute("tipo_propietario");
