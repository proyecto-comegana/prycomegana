...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar usuario</title>
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO RESPUESTA CONSULTAR USUARIO -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO RESPUESTA CONSULTAR USUARIO</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="lCodigo" value="${codigo_usuario}"/></td>
              									</tr>
				
              									<tr>
	             									<td><form:label path="sNombreUsuario">Nombre de usuario: </form:label></td>
                  									<td><form:input size="110" path="sNombreUsuario" value="${nomusua_usuario}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sContrasena">Contrase&nacute;a: </form:label></td>
                  									<td><form:input size="110" path="sContrasena" value="${contra_usuario}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iTipo">Tipo: </form:label></td>
                  									<td><form:input size="110" path="iTipo" value="${tipo_usuario}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lPersona">Persona: </form:label></td>
                  									<td><form:input size="110" path="lPersona" value="${persona_usuario}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_usuario}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_usuario}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
...
<%
	session.removeAttribute("codigo_usuario");
	session.removeAttribute("nomusua_usuario");
	session.removeAttribute("contra_usuario");
	session.removeAttribute("tipo_usuario");
	session.removeAttribute("persona_usuario");
	session.removeAttribute("fecha_usuario");
	session.removeAttribute("hora_usuario");
%>
</body>
</html>