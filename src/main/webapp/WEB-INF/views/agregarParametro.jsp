...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear par&aacute;metro</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Diligencie los datos del par&aacute;metro</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO AGREGAR PARAMETRO-->
								<div id="fields">
									  <c:url value="/rAgregarParametro" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>DATOS DEL PARAMETRO</legend>
          									<table>
              									<tr>
              									...
              									<tr>
                  									...
                  									<td><form:input size="110" path="lValor" /></td>
              									</tr>
              									<tr>
