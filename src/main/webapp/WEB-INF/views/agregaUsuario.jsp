				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO USUARIO-->
								<div id="fields">
									  <c:url value="/rAgregarUsuario" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
          									...
          									<table>
              									<tr>
                  									...
                  									<td><form:input size="110" path="sNombreUsuario" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sContrasena">Contraseña: </form:label></td>
                  									<td><form:input type="password" size="120" style="height:38px" path="sContrasena" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sTipo">Tipo de usuario: </form:label></td>
                  									<td>
                  										<form:select path="sTipo" value="NONE" style="min-width:765px;height:37px;">
