...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina actualizar cliente y sucesor</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del cliente y del sucesor</h2>
				<p>Actualice los datos del cliente y del sucesor</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CLIENTE SUCESOR -->
								<div id="fields">
								      <c:url value="/r2ActualizarClienteSucesor" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO ACTUALIZAR CLIENTE Y SUCESOR</legend>
          									<table>
              									<tr>
              									...
              									<tr>
	             									<td><form:label path="lSucesor">Sucesor: </form:label></td>
