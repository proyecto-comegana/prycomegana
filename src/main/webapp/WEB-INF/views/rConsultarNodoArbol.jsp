...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina resultados consultar nodo y &aacute;rbol</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del nodo y &aacute;rbol</h2>
				<p>Informaci&oacute;n  del nodo y &aacute;rbol</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR NODO Y ARBOL -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR NODO Y ARBOL</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lNodo">Nodo: </form:label></td>
                  									<td><form:input size="110" path="lNodo" value="${nodo_nodoarbol}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lArbol">&Aacute;rbol: </form:label></td>
                  									<td><form:input size="110" path="lArbol" value="${arbol_nodoarbol}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_nodoarbol}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_nodoarbol}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
