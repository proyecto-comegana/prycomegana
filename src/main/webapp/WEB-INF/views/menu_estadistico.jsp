	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del reporte</h2>
				<p>Diligencie los datos para generar el reporte</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<h1>Seleccione un tipo de informe estad&iacute;stico</h1>
						<br>
						<br>
						<ul>
							<li><a href="<c:url value="estadis_diaria"/>"><img src="<c:url value="/resources/images/ok.png"/>"/>Accesos de usuario diarios</img></a></li>
							<li><a href="<c:url value="estad_mensual"/>"><img src="<c:url value="/resources/images/ok.png"/>"/>Accesos de usuario mensuales</img></a></li>
							<li><a href="<c:url value="estad_anual"/>"><img src="<c:url value="/resources/images/ok.png"/>"/>Accesos de usuario anuales</img></a></li>
						</ul>
						<!-- PAGINATION -->
