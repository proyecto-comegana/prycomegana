...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar nodo y &aacute;rbol</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del nodo y el &aacute;rbol</h2>
				<p>Diligencie los datos del nodo y el &aacute;rbol</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
									  <c:url value="/rConsultarNodoArbol" var="formUrl"/>
