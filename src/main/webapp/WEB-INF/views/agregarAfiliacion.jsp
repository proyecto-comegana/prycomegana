...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear afiliaci&oacute;n</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Diligencie los datos de la afiliaci&oacute;n</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO AGREGAR AFILIACION-->
								<div id="fields">
									  <c:url value="/agregarPersona" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO AGREGAR AFILIACION</legend>
          									<table>
              									<tr>
                  									<td><form:label path="lClientePadre">Cliente padre: </form:label></td>
                  									<td><form:input size="110" path="lClientePadre" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="lClienteHijo">Cliente hijo: </form:label></td>
                  									<td><form:input size="110" path="lClienteHijo" /></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sCiudad">Ciudad:</form:label></td> 
                  									<td>
                  										<form:select path="sCiudad" style="min-width:780px;height:37px;">
