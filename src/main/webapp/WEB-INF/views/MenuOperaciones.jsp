				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<div id="fields">
								      		<h1>Operaciones Comegana - Usuario administrador</h1>
								      		<br><br>
          									<table>
              									<tr bgcolor= #f2f3f4 >
             									...
             									<tr>
              										<td width=140>accesos</td>
              										<td width=140><img src="<c:url value="/resources/images/insertar.ico"/>" width=20px height=35px> <a href="<c:url value="agregarAcceso"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar.ico"/>" width=20px height=29px>  <a href="<c:url value="consultarAcceso"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarAcceso"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar.ico" />" width=20px height=20px> <a href="<c:url value="borrarAcceso"/>">Borrar</a></td>
              									...
              									<tr  bgcolor= #f2f3f4 >
              										...
              										<td width=140><img src="<c:url value="/resources/images/insertar_gris.ico"/>" width=20px height=35px> <a href="<c:url value="agregarArea"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar_gris.ico" />" width=20px height=20px> <a href="<c:url value="consultarArea"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit_gris.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarArea"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar_gris.ico" />" width=20px height=20px> <a href="<c:url value="borrarArea"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              									...
              									<tr bgcolor= #f2f3f4 >
              										<td width=140>convenios</td>
              										<td width=140><img src="<c:url value="/resources/images/insertar_gris.ico"/>" width=20px height=35px> <a href="<c:url value="agregarConvenio"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar_gris.ico" />" width=20px height=20px> <a href="<c:url value="consultarConvenio"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit_gris.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarConvenio"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar_gris.ico" />" width=20px height=20px> <a href="<c:url value="borrarConvenio"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              									...
              									<tr  bgcolor= #f2f3f4 >
              										<td width=140>empleado</td>
              										<td width=140><img src="<c:url value="/resources/images/insertar_gris.ico"/>" width=20px height=35px> <a href="<c:url value="agregarEmpleado"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar_gris.ico" />" width=20px height=20px> <a href="<c:url value="consultarEmpleado"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit_gris.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarEmpleado"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar_gris.ico" />" width=20px height=20px> <a href="<c:url value="borrarEmpleado"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              										<td width=140>fallos</td>
              										<td width=140><img src="<c:url value="/resources/images/insertar.ico"/>" width=20px height=35px> <a href="<c:url value="agregarFallo"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar.ico"/>" width=20px height=29px>  <a href="<c:url value="consultarFallo"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarFallo"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar.ico" />" width=20px height=20px> <a href="<c:url value="borrarFallo"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr bgcolor= #f2f3f4 >
              										<td width=140>modulos</td>
              										<td width=140><img src="<c:url value="/resources/images/insertar_gris.ico"/>" width=20px height=35px> <a href="<c:url value="agregarModulo"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar_gris.ico" />" width=20px height=20px> <a href="<c:url value="consultarModulo"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit_gris.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarModulo"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar_gris.ico" />" width=20px height=20px> <a href="<c:url value="borrarModulo"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              									...
              									<tr  bgcolor= #f2f3f4 >
              										<td width=140>par&aacute;metro</td>
              										<td width=140><img src="<c:url value="/resources/images/insertar_gris.ico"/>" width=20px height=35px> <a href="<c:url value="agregarParametro"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar_gris.ico" />" width=20px height=20px> <a href="<c:url value="consultarParametro"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit_gris.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarParametro"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar_gris.ico" />" width=20px height=20px> <a href="<c:url value="borrarParametro"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              										<td width=140>par&aacute;metromodulo</td>
              										<td width=140><img src="<c:url value="/resources/images/insertar.ico"/>" width=20px height=35px> <a href="<c:url value="agregarParametroModulo"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar.ico"/>" width=20px height=29px>  <a href="<c:url value="consultarParametroModulo"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarParametroModulo"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar.ico" />" width=20px height=20px> <a href="<c:url value="borrarParametroModulo"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr  bgcolor= #f2f3f4 >
              									...
              									<tr  bgcolor= #f2f3f4 >
              										...
              										<td width=140><img src="<c:url value="/resources/images/insertar_gris.ico"/>" width=20px height=35px> <a href="<c:url value="agregarPropietario"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar_gris.ico" />" width=20px height=20px> <a href="<c:url value="consultarPropietario"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit_gris.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarPropietario"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar_gris.ico" />" width=20px height=20px> <a href="<c:url value="borrarPropietario"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              									...
              									<tr  bgcolor= #f2f3f4 >
              										<td width=140>tarifas</td>
              										<td width=140><img src="<c:url value="/resources/images/insertar_gris.ico"/>" width=20px height=35px> <a href="<c:url value="agregarTarifa"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar_gris.ico" />" width=20px height=20px> <a href="<c:url value="consultarTarifa"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit_gris.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarTarifa"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar_gris.ico" />" width=20px height=20px> <a href="<c:url value="borrarTarifa"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              										<td width=140>tipobackup</td>
              										<td width=140><img src="<c:url value="/resources/images/insertar.ico"/>" width=20px height=35px> <a href="<c:url value="agregarTipoBackup"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar.ico"/>" width=20px height=29px>  <a href="<c:url value="consultarTipoBackup"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarTipoBackup"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar.ico" />" width=20px height=20px> <a href="<c:url value="borrarTipoBackup"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr  bgcolor= #f2f3f4 >
              										<td width=140>tipoparametro</td>
              										<td width=140><img src="<c:url value="/resources/images/insertar_gris.ico"/>" width=20px height=35px> <a href="<c:url value="agregarTipoParametro"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar_gris.ico" />" width=20px height=20px> <a href="<c:url value="consultarTipoParametro"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit_gris.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarTipoParametro"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar_gris.ico" />" width=20px height=20px> <a href="<c:url value="borrarTipoParametro"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              									...
              									<tr  bgcolor= #f2f3f4 >
              										<td width=140>tipousuario</td>
              										<td width=140><img src="<c:url value="/resources/images/insertar_gris.ico"/>" width=20px height=35px> <a href="<c:url value="agregarTipoUsuario"/>">Insertar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/buscar_gris.ico" />" width=20px height=20px> <a href="<c:url value="consultarTipoUsuario"/>">Consultar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/edit_gris.ico"/>" width=20px height=20px>  <a href="<c:url value="actualizarTipoUsuario"/>">Actualizar</a></td>
              										<td width=140><img src="<c:url value="/resources/images/borrar_gris.ico" />" width=20px height=20px> <a href="<c:url value="borrarTipoUsuario"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
          									...
          									<br>
          									<br>
          									<p><a href="<c:url value="menu_estadistico"/>">Consultar estad&iacute;sticas</a></p>
								</div>
							</div>
						<!-- PAGINATION -->
