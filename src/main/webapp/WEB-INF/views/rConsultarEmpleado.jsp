...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar empleado</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del empleado</h2>
				<p>Informaci&oacute;n  del empledao</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR EMPLEADO -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR EMPLEADO</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lEmpleado">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="lEmpleado" value="${codigo_empleado}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iCargo">Cargo: </form:label></td>
                  									<td><form:input size="110" path="iCargo" value="${cargo_empleado}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iArea">Area: </form:label></td>
                  									<td><form:input size="110" path="iArea" value="${area_empleado}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lPersona">Persona: </form:label></td>
                  									<td><form:input size="110" path="lPersona" value="${persona_empleado}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_empleado}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_empleado}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
...
<%
	session.removeAttribute("codigo_empleado");
	session.removeAttribute("cargo_empleado");
	session.removeAttribute("area_empleado");
	session.removeAttribute("persona_empleado");
	session.removeAttribute("fecha_empleado");
	session.removeAttribute("hora_empleado");
%>
</body>
</html>