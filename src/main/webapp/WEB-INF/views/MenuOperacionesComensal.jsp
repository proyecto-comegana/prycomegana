				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<div id="fields">
								      		<h1>Operaciones Comegana - Para comensal</h1>
								      		<br><br>
          									<table>
              									<tr bgcolor= #f2f3f4 >
              									...
              									<tr bgcolor= #f2f3f4 >
              										...
              										<td width=140><img src="" width=20px height=35px> <a href=""/>">Insertar</a></td>
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarBonificacion"/>">Actualizar</a></td>
              										<td width=140><img src="" />" width=20px height=20px> <a href="<c:url value="borrarBonificacion"/>">Borrar</a></td>
              									...
              									<tr>
              										...
              										<td width=140><img src="" width=20px height=35px> <a href="<c:url value="agregarCiudad"/>">Insertar</a></td>
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarCiudad"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarCiudad"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr bgcolor= #f2f3f4 >
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarCliente"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarCliente"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              										<td width=140>clientepremio</td>
              										<td width=140><img src="" width=20px height=35px> <a href="<c:url value="agregarClientePremio"/>">Insertar</a></td>
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarClientePremio"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarClientePremio"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr bgcolor= #f2f3f4 >
              										<td width=140>clientesucesor</td>
              										<td width=140><img src="" width=20px height=35px> <a href="<c:url value="agregarClienteSucesor"/>">Insertar</a></td>
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarClienteSucesor"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarClienteSucesor"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              										<td width=140>departamento</td>
              										<td width=140><img src="" width=20px height=35px> <a href="<c:url value="agregarDepartamento"/>">Insertar</a></td>
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarDepartamento"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarDepartamento"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr bgcolor= #f2f3f4 >
              										<td width=140>pa&iacute;s</td>
              										<td width=140><img src="" width=20px height=35px> <a href="<c:url value="agregarPais"/>">Insertar</a></td>
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarPais"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarPais"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              										<td width=140>premios</td>
              										<td width=140><img src="" width=20px height=35px> <a href="<c:url value="agregarPremios"/>">Insertar</a></td>
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarPremios"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarPremios"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr bgcolor= #f2f3f4>
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarRecargas"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarRecargas"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              										<td width=140>recargatarifa</td>
              										<td width=140><img src="" width=20px height=35px> <a href="<c:url value="agregarRecargaTarifa"/>">Insertar</a></td>
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarRecargaTarifa"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarRecargaTarifa"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado_gris.ico" />" width=16px height=16px> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr bgcolor= #f2f3f4>
              										<td width=140>restaurante</td>
              										<td width=140><img src="" width=20px height=35px> <a href="<c:url value="agregarRestaurante"/>">Insertar</a></td>
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarRestaurante"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarRestaurante"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr>
              										<td width=140>tiporestaurante</td>
              										<td width=140><img src="" width=20px height=35px> <a href="<c:url value="agregarTipoRestaurante"/>">Insertar</a></td>
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarTipoRestaurante"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarTipoRestaurante"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
              									<tr bgcolor= #f2f3f4 >
              										...
              										<td width=140><img src="" width=20px height=20px>  <a href="<c:url value="actualizarUsuario"/>">Actualizar</a></td>
              										<td width=140><img src="" width=20px height=20px> <a href="<c:url value="borrarUsuario"/>">Borrar</a></td>
													<td width=140><img src="<c:url value="/resources/images/listado.ico" />" width=16px height=16x> <a href="<c:url value=""/>">Listar</a></td>
              									</tr>
          									</table>
								</div>
