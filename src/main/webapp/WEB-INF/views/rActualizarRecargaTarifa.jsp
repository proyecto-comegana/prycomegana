...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina actualizar recarga y tar&iacute;fa</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Actualice los datos de recarga y tar&iacute;fa</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO RECARGA Y TARIFA -->
								<div id="fields">
								      <c:url value="/r2ActualizarRecargaTarifa" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO ACTUALIZAR RECARGA Y TARIFA</legend>
          									<table>
              									<tr>
