...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina agregar restaurante</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del restaurante</h2>
				<p>Diligencie los datos del restaurante</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO AGREGAR CONVENIO -->
								<div id="fields">
									  <c:url value="/rAgregarRestaurante" var="formUrl"/>
          									...
          									<table>
              									<tr>
	             									<td><form:label path="sNombre">Nombre: </form:label></td>
                  									<td><form:input rows="5" cols="30" size="110" path="sNombre"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sDescripcion">Descripci&oacute;n: </form:label></td>
                  									<td><form:textarea rows="5" cols="30" size="110" path="sDescripcion"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sTelefono">Tel&eacute;fono: </form:label></td>
                  									<td><form:input rows="5" cols="30" size="110" path="sTelefono"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lPropietario">Propietario: </form:label></td>
                  									<td><form:input rows="5" cols="30" size="110" path="lPropietario"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iConvenio">Convenio: </form:label></td>
                  									<td><form:input rows="5" cols="30" size="110" path="iConvenio"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iTipo">Tipo: </form:label></td>
                  									<td><form:input rows="5" cols="30" size="110" path="iTipo"/></td>
              									</tr>
              									<tr>
					...
					<div class="sidebar col-lg-3 col-md-3 padbot50">
						...
						<div class="sidepanel widget_popular_posts">
							...
							<div class="recent_posts_widget clearfix">
								...
								<div class="post_item_content_widget">
									<a class="title" href="<c:url value="blog"/>" >Disfrute los deliciosos platos t&iacute;ipicos de hasta los mas grandes y reconocidos restaurantes de la ciudad
									a costos muy razonables y con una excelente preparaci&oacute;n</a>
									<ul class="post_item_inf_widget">
										<li>SEPTIEMBRE 29  |  21:30</li>
									</ul>
								</div>
							</div>
							<div class="recent_posts_widget clearfix">
								...
								<div class="post_item_content_widget">
									<a class="title" href="<c:url value="blog"/>" >Disfrute de variedades de platos de comida en cualquiera de los restaurantes m&aacue;s cercanos a su ubicaci&oacute;n</a>
									<ul class="post_item_inf_widget">
										<li>SEPTIEMBRE 20  |  9:30</li>
									</ul>
								</div>
							</div>
							<div class="recent_posts_widget clearfix">
						...
						<div class="sidepanel widget_text">
							...
							<p>FDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD.</p>
						</div><!-- //TEXT WIDGET -->
					</div><!-- //SIDEBAR -->
				</div><!-- //ROW -->
			</div><!-- //CONTAINER -->
