...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear arbol</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del arbol</h2>
				<p>Diligencie los datos del arbol</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO AGREGAR FALLO-->
								<div id="fields">
									  <c:url value="/rAgregarArbol" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>AGREGAR DATOS DEL ARBOL</legend>
          									<table>
              									<tr>
                  									<td><form:label path="iNiveles">Niveles: </form:label></td>
                  									<td><form:input size="110" path="iNiveles" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="iElementos">Elementos: </form:label></td>
                  									<td><form:input size="110" path="iElementos" /></td>
              									</tr>
              									<tr>
