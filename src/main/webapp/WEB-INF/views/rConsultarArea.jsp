...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar area</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del area</h2>
				<p>Informaci&oacute;n  del area</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR AREA -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR AREA</legend>
          									<table>
              									<tr>
	             									<td><form:label path="iCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="iCodigo" value="${codigo_area}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sNombre">Nombre: </form:label></td>
                  									<td><form:input size="110" path="sNombre" value="${nombre_area}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sDescripcion">Descripci&oacute;n: </form:label></td>
                  									<td><form:input size="110" path="sDescripcion" value="${descrip_area}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_area}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_area}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
...
<%
	session.removeAttribute("codigo_area");
	session.removeAttribute("nombre_area");
	session.removeAttribute("descrip_area");
	session.removeAttribute("fecha_area");
	session.removeAttribute("hora_area");
%>
</body>
</html>