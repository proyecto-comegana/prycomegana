...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear usuario</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Diligencie los datos del usuario</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO USUARIO-->
								<div id="fields">
									  <c:url value="/rAgregarUsuarioReg" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
          									...
          									<table>
              									<tr>
                  									...
                  									<td><form:input type="password" size="120" style="height:38px" path="sNombreUsuario" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sContrasena">Contraseña: </form:label></td>
                  									<td><form:input size="110" path="sContrasena" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sTipo">Tipo de usuario: </form:label></td>
                  									<td>
                  										<form:select path="sTipo" value="NONE" style="min-width:785px;height:37px;">
              											<form:option value="NONE" selected="selected" label="Seleccione una opción"/>
              											<form:options items="${lstRolesUsuario}" />
              											</form:select>
              										</td>
              									</tr>
              									<tr>
