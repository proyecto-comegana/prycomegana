...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina pa&iacute;s</title>
...
<%
	...
	System.out.println("Usuario: "+session.getAttribute("param_usuario"));
%>
...
(function (){
	...
	setInterval(validarHora, 10000);//TEMPORIZADOR QUE LLAMA LA FUNCION CADA 500 ms
	setInterval(validarFecha, 10000);//TEMPORIZADOR QUE LLAMA LA FUNCION CADA 500 ms
...
<script type="text/javascript">
	$(function() {
		...
		$(document).ready(function(){ 
			...
			$("#sNombre").keydown(function(event) {
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del pa&iacute;s</h2>
				<p>Diligencie los datos del pa&iacute;s</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO AGREGAR PAIS -->
								<div id="fields">
									  <c:url value="/rAgregarPais" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO AGREGAR PAIS</legend>
          									<table>
              									<tr>
	             									<td><form:label path="sNombre">Nombre: </form:label></td>
                  									<td><form:input size="110" path="sNombre" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha (mm/dd/aa): </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_actual}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora (hh:mm): </form:label></td>
					...
					<div class="sidebar col-lg-3 col-md-3 padbot50">
						...
						<div class="sidepanel widget_popular_posts">
							...
							<div class="recent_posts_widget clearfix">
								...
								<div class="post_item_content_widget">
									<a class="title" href="<c:url value="blog"/>" >Tener un restaurante con la aplicaci&oacute;n Comegana te permitirá formar una popularidad entre los comensales de la comida preparada que ofreces, y lo más importante, te permitir&aacute; disminuir los costos.</a>
							...
							<div class="recent_posts_widget clearfix">
								...
								<div class="post_item_content_widget">
									<a class="title" href="<c:url value="blog"/>" >Gestionamos con restaurantes de lujo (cinco tenedores), excelente organización interna y externa, para que puedas disfrutar deliciosos platillos de forma oportuna y a comodos precios </a>
									<ul class="post_item_inf_widget">
										<li>ENERO 25  |  9:30</li>
									</ul>
								</div>
							...
							<div class="recent_posts_widget clearfix">
								...
								<div class="post_item_content_widget">
									<a class="title" href="<c:url value="blog"/>" >Disfrute de la comida preparada en los mejores restaurantes paradisiacos gracias a nuestros servicios de tecnolog&iacute;a</a>
									<ul class="post_item_inf_widget">
						...
						<div class="sidepanel widget_text">
							...
							<p>Anualmente un tercio de la comida es arrojada a los cestos de la basura, Comegana est&aacute; a favor de la ley anti-desperdicios, permitiendo a las personas comprar comida sobrente a costos reducidos</p>
						</div><!-- //TEXT WIDGET -->
					</div><!-- //SIDEBAR -->
				</div><!-- //ROW -->
			</div><!-- //CONTAINER -->
