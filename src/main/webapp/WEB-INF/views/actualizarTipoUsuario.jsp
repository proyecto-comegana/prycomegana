...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina actualizar tipo de usuario</title>
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<div id="fields">
									  <c:url value="/rActualizarTipoUsuario" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDA ACTUALIZAR TIPO DE USUARIO</legend>
          									<table>
              									<tr>
