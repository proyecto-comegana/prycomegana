...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina resultado consultar cliente</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del cliente</h2>
				<p>Actualice la informaci&oacute;n del cliente</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
          									...
          									<table>
              									<tr>
	             									<td><form:label path="lCedula">Cedula:</form:label></td>
                  									<td><form:input size="110" path="lCedula" value="${cedula_cliente}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="lNumArbol">N&uacute;mero del &aacute;rbol: </form:label></td>
                  									<td><form:input size="110" path="lNumArbol" value="${numarbol_cliente}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="lNivel">Nivel en el &aacute;rbol: </form:label></td>
                  									<td><form:input size="110" path="lNivel" value="${nivel_cliente}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="lPredecesor">Predecesor: </form:label></td>
                  									<td><form:input size="110" path="lPredecesor" value="${predecesor_cliente}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="lPersona">Persona: </form:label></td>
                  									<td><form:input size="110" path="lPersona" value="${persona_cliente}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="lSaldo">Saldo: </form:label></td>
                  									<td><form:input size="110" path="lSaldo" value="${saldo_cliente}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="lBonos">Bonos: </form:label></td>
                  									<td><form:input size="110" path="lBonos" value="${bonos_cliente}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="iPremio">Premio: </form:label></td>
                  									<td><form:input size="110" path="iPremio" value="${premio_cliente}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_cliente}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_cliente}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
                  										<input type="submit" value="Insertar" class="btn btn-primary btn-lg"/>
...
<%
	session.getAttribute("cedula_cliente");
	session.getAttribute("numarbol_cliente");
	session.getAttribute("nivel_cliente");
	session.getAttribute("predecesor_cliente");
	session.getAttribute("persona_cliente");
	session.getAttribute("saldo_cliente");
	session.getAttribute("bonos_cliente");
	session.getAttribute("premio_cliente");
	session.getAttribute("fecha_cliente");
	session.getAttribute("hora_cliente");
%>
</html>