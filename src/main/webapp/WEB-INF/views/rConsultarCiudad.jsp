	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Informaci&oacute;n  de la ciudad</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR CIUDAD</legend>
          									<table>
              									<tr>
              									...
              									<tr align="center">
                  									<td colspan="2">
                  										<input type="submit" id="btnactualizar" value="Regresar" class="btn btn-primary btn-lg"/>
                 									</td>
              									</tr>
          									</table>
      									</form:form>
