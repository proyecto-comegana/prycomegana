...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina respuesta actualizar &aacute;rbol</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Visualizaci&oacute;n de los datos del &aacute;rbol</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
...
<%
	...
	session.removeAttribute("fecha_arbol");
	session.removeAttribute("hora_arbol");
