...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina agregar cliente</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Diligencie los datos del cliente</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
								      ...
								      <form:form class="clearfix" method="GET" action="${formUrl}">
          									...
          									<table>
              									...
              									<tr>
                  									...
                  									<td><form:input size="110" path="lSaldo" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="lBonos">Bonos: </form:label></td>
                  									<td><form:input size="110" path="lBonos" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="iPremio">Premio: </form:label></td>
                  									<td><form:input size="110" path="iPremio" /></td>
              									</tr>
              									<tr>
