...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina respuesta actualizar persona</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Visualizaci&oacute;n de los datos de la persona</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
...
<%
	session.removeAttribute("codigo_persona");
	session.removeAttribute("nombre_persona");
	session.removeAttribute("apel_persona");
	session.removeAttribute("dir_persona");
	session.removeAttribute("tel_persona");
	session.removeAttribute("correo_persona");
	session.removeAttribute("fnac_persona");
	session.removeAttribute("sexo_persona");
	session.removeAttribute("ciudad_persona");
	session.removeAttribute("fecha_persona");
	session.removeAttribute("hora_persona");
