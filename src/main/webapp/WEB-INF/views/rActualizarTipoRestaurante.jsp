...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina actualizar tipo de restaurante</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Actualice los datos del tipo de restaurante</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO TIPO DE RESTAURANTE -->
								<div id="fields">
								      <c:url value="/r2ActualizarTipoRestaurante" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO ACTUALIZAR TIPO DE RESTAURANTE</legend>
          									<table>
              									<tr>
