...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear acceso</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Diligencie los datos del acceso</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
									  <c:url value="/rAgregarAcceso" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
          									...
          									<table>
              									...
              									<tr>
                  									...
                  									<td><form:input size="110" path="lUsuario" /></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
