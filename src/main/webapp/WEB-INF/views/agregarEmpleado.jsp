...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina agregar empleado</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Diligencie los datos del empleado</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
