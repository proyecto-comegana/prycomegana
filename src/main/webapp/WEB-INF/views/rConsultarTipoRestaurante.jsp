...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar tipo de restaurante</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del tipo de restaurante</h2>
				<p>Informaci&oacute;n  del tipo de restaurante</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR TIPO DE RESTAURANTE -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR TIPO DE RESTAURANTE</legend>
          									<table>
              									<tr>
	             									<td><form:label path="iCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="iCodigo" value="${codigo_trestaurante}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sNombre">Nombre: </form:label></td>
                  									<td><form:input size="110" path="sNombre" value="${nombre_trestaurante}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sDescripcion">Descripcion: </form:label></td>
                  									<td><form:input size="110" path="sDescripcion" value="${descrip_trestaurante}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_trestaurante}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_trestaurante}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
...
<%
	session.removeAttribute("codigo_trestaurante");
	session.removeAttribute("nombre_trestaurante");
	session.removeAttribute("descrip_trestaurante");
	session.removeAttribute("fecha_trestaurante");
	session.removeAttribute("hora_trestaurante");
%>
</body>
</html>