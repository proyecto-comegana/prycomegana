...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear recarga y tar&iacute;fa</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> de la recarga y tar&iacute;fa</h2>
				<p>Diligencie los datos de la recarga y tar&iacute;fa</p>
			</div>
		</section><!-- //BREADCRUMBS -->
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO AGREGAR RECARGA Y TARIFA -->
								<div id="fields">
									  <c:url value="/rAgregarRecargaTarifa" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>DATOS RECARGA Y TARIFA</legend>
          									<table>
              									<tr>
                  									<td><form:label path="lRecarga">Recarga: </form:label></td>
                  									<td><form:input size="110" path="lRecarga" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="iTarifa">Tar&iacute;fa: </form:label></td>
                  									<td><form:input size="110" path="iTarifa" /></td>
              									</tr>
              									<tr>
