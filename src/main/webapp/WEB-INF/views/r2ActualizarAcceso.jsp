...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina respuesta actualizar acceso</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Visualizaci&oacute;n de los datos del acceso</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
...
<%
	session.removeAttribute("codigo_acceso");
	session.removeAttribute("ip_acceso");
	session.removeAttribute("modulo_acceso");
	session.removeAttribute("pagina_acceso");
	session.removeAttribute("objeto_acceso");
	session.removeAttribute("tabla_acceso");
	session.removeAttribute("operacion_acceso");
	session.removeAttribute("accion_acceso");
	session.removeAttribute("proceso_acceso");
	session.removeAttribute("estadotarea_acceso");
	session.removeAttribute("comando_acceso");
	session.removeAttribute("aplicacion_acceso");
	session.removeAttribute("tiempo_acceso");
	session.removeAttribute("transaccion_acceso");
	session.removeAttribute("fecha_acceso");
	session.removeAttribute("hora_acceso");
	session.removeAttribute("usuario_acceso");
