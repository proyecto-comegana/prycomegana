...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina respuesta crear tipo par&aacute;metro</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Respuesta creación del tipo de par&aacute;metro</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO RESPUESTA CREAR TIPO DE PARAMETRO -->
								<div id="fields">
									<h1>${mensaje}</h1>
								</div>
							</div>
