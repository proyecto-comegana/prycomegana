...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina resultados consultar cliente y premio</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del cliente y premio</h2>
				<p>Informaci&oacute;n  del cliente y el premio</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR CLIENTE Y PREMIO -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR CLIENTE Y PREMIO</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lCliente">Cliente: </form:label></td>
                  									<td><form:input size="110" path="lCliente" value="${cliente_clientepremio}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iPremio">Descripci&iacute;n: </form:label></td>
                  									<td><form:input size="110" path="iPremio" value="${premio_clientepremio}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_clientepremio}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_clientepremio}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
