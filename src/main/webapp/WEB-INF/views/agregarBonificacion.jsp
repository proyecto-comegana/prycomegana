...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina bonificaci&oacute;nes</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> de bonificaciones</h2>
				<p>Diligencie los datos de bonos conseguidos</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO AGREGAR BONIFICACIONES -->
								<div id="fields">
									  <c:url value="/rAgregarBonificacion" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>DATOS BONIFICACIONES</legend>
          									<table>
              									<tr>
                  									<td><form:label path="lCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="lCodigo" /></td>
              									</tr>
              									<tr>
