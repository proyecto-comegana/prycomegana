				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO BUSQUEDA PARA ACTUALIZAR AFILIACION -->
								<div id="fields">
									  <c:url value="/rActualizarAfiliacion" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDA PARA ACTUALIZAR AFILIACION</legend>
          									<table>
              									<tr>
