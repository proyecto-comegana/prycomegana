...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina departamento</title>
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
		...
		$(function() {
				...
				$(document).ready(function(){
		    		var opcion = document.getElementById("nPais").value;
				    $("#sPais").val(opcion);
				    $('#sPais').change();
				});
				//AL CAMBIAR EL DOCUMENTO ACTUALIZA VALOR DEL CAMPO HIDDEN
		    	$(document).on('change', '#sPais', function(event) {
		    		$('#nPais').val($("#sPais:selected").text());
		    	});
		});
	</script>      	
</head>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del departamento</h2>
				<p>Informaci&oacute;n  del departamento</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR PAIS -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR DEPARTAMENTO</legend>
          									<table>
              									<tr>
	             									<td><form:label path="iCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="iCodigo" value="${codigo_depto}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sNombre">Nombre: </form:label></td>
                  									<td><form:input size="110" path="sNombre" value="${nombre_depto}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sPais">Pa&iacute;s:</form:label></td> 
                  									<td>
                  										<form:select id="sPais" path="sPais" style="min-width:780px;height:37px;">
              											<form:option value="NONE" label="Seleccione una opción"/>
              											<form:options items="${lstPaises}"/>
														</form:select>
														<input type="hidden" id="nPais" name="hPais" value="${nombre_pais}"/>														
              										</td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_depto}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_depto}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
