				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
								      <form:form class="clearfix" method="POST" action="insertaPersona">
          									...
          									<table>
              									...
              									<tr>
													...
													<!--  <div id="sFecha_Nac"></div> -->                 			
													<!-- <input type="text" id="sFecha_Nac"/>  -->						
              									</tr>            
              									<tr>
...
$ (function () {
    $.datepicker.setDefaults ({
        onClose: función (fecha, inst) {
            $ ("# selectedDtaeVal"). html (fecha);
        }
    });
...
<script>/*
	$ (function(){
		//Datepicker
		$('form:input[name=sFecha_Nac]').datepicker({
			inline: true,
			format:'yyyy-mm-dd'
		});
	}*/
