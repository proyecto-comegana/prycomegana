...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina respuesta crear backup</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> de la recuperacion de la base de datos</h2>
				<p>Respuesta recuperar base de datos</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO RESPUESTA CREAR BACKUP-->
								<div id="fields">
									<h1>${mensaje}</h1>
<%
	Process proceso;
	...
	if (con != null)
		System.out.println("Esta conectado a la base de datos comegana...");
	else
	...
	try {
	    ...
	    out.println("<h1><La base de datos ha sido recuperada exitosamente...</h1>");
	} catch (Exception e) {
	    e.printStackTrace();
	}
%>
