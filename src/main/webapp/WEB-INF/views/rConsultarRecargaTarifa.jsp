...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina resultados consultar recarga y tar&iacute;fa</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> de la recarga y la tar&iacute;fa</h2>
				<p>Informaci&oacute;n  de la recarga y la tar&iacute;fa</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR RECARGA Y TARIFA -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR RECARGA Y TARIFA</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lRecarga">Recarga: </form:label></td>
                  									<td><form:input size="110" path="lRecarga" value="${recarga_recargatarifa}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iTarifa">Tar&iacute;fa: </form:label></td>
                  									<td><form:input size="110" path="iTarifa" value="${tarifa_recargatarifa}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_recargatarifa}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_recargatarifa}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
...
<%
	session.removeAttribute("recarga_recargatarifa");
	session.removeAttribute("tarifa_recargatarifa");
	session.removeAttribute("fecha_recargatarifa");
	session.removeAttribute("hora_recargatarifa");
%> 
</body>
</html>