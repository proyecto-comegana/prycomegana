...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina actualizar premio</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del premio</h2>
				<p>Actualice los datos del premio</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CIUDAD -->
								<div id="fields">
								      <c:url value="/r2ActualizarPremio" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO ACTUALIZAR PREMIO</legend>
          									<table>
              									<tr>
	             									<td><form:label path="iCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="iCodigo" value="${codigo_premio}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sDescripcion">Descripci&oacute;n: </form:label></td>
                  									<td><form:input size="110" path="sDescripcion" value="${descrip_premio}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lValor">Valor: </form:label></td>
                  									<td><form:input size="110" path="lValor" value="${valor_premio}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_premio}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_premio}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
