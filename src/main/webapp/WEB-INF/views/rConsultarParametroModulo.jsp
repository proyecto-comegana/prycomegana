...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina resultados consultar par&aacute;metro y modulo</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del par&aacute;metro y modulo</h2>
				<p>Informaci&oacute;n  del par&aacute;metro y modulo</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR PARAMETRO Y MODULO -->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR PARAMETRO Y MODULO</legend>
          									<table>
              									<tr>
	             									<td><form:label path="iParametro">Parametro: </form:label></td>
                  									<td><form:input size="110" path="iParametro" value="${parametro_paramod}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iModulo">Modulo: </form:label></td>
                  									<td><form:input size="110" path="iModulo" value="${modulo_paramod}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_paramod}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_paramod}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
...
<%
	session.removeAttribute("cliente_clientepremio");
	session.removeAttribute("premio_clientepremio");
	session.removeAttribute("fecha_clientepremio");
	session.removeAttribute("hora_clientepremio");
%> 
</body>
</html>