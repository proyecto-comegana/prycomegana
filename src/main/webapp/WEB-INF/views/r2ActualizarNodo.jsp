...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina respuesta actualizar nodo</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Visualizaci&oacute;n de los datos del nodo</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
...
<%
	session.removeAttribute("codigo_nodo");
	session.removeAttribute("cliente_nodo");
	session.removeAttribute("arbol_nodo");
	session.removeAttribute("posicion_nodo");
	session.removeAttribute("estado_nodo");
	session.removeAttribute("nivel_nodo");
	session.removeAttribute("fecha_nodo");
	session.removeAttribute("hora_nodo");
