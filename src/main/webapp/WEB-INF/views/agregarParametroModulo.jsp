...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear par&aacute;metro y modulo</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del par&aacute;metro y el modulo</h2>
				<p>Diligencie los datos del par&aacute;metro y el modulo</p>
			</div>
		</section><!-- //BREADCRUMBS -->
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO AGREGAR PARAMETRO Y MODULO -->
								<div id="fields">
									  <c:url value="/rAgregarParametroModulo" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>DATOS PARAMETRO Y MODULO</legend>
          									<table>
              									<tr>
                  									<td><form:label path="iParametro">Par&aacute;metro: </form:label></td>
                  									<td><form:input size="110" path="iParametro" /></td>
              									</tr>
              									<tr>
