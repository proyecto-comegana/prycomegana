...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina busqueda borrar nodo arbol</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Buscar datos para borrar el nodo y el árbol</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO BUSQUEDA BORRAR NODO Y EL ARBOL -->
								<div id="fields">
									  <c:url value="/rBorrarNodoArbol" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDA PARA BORRAR NODO Y ARBOL</legend>
          									<table>
              									<tr>
