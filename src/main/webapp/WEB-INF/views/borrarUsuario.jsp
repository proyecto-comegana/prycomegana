...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina borrar usuario</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Eliminaci&oacute;n de los datos del usuario</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO BUSQUEDA BORRAR USUARIO -->
								<div id="fields">
									  <c:url value="/rBorrarUsuario" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BUSQUEDA BORRAR USUARIO</legend>
          									<table>
              									<tr>
