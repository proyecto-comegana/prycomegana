...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear departamento</title>
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
									  <c:url value="/rAgregarDepartamento" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>AGREGAR DATOS DEL DEPARTAMENTO</legend>
          									<table>
              									<tr>
              									...
              									<tr>
	             									<td><form:label path="sPais">Pa&iacute;s:</form:label></td> 
                  									<td>
                  										<form:select path="sPais" style="min-width:780px;height:37px;">
