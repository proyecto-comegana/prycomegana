...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina respuesta crear usuario</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Respuesta creación del usuario</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO RESPUESTA CREAR USUARIO -->
								<div id="fields">
									<h1>${mensaje_afil}</h1>
									<h1>${mensaje_person}</h1>
									<h1>${mensaje_usuar}</h1>
									<h1>${Info_arbol}</h1>
									<h1>${Info_nodo}</h1>
									<h1>${Info_cliente}</h1>
									<h1>${Info_NodoArbol}</h1>
									<h1>${msj_usuar}</h1>																		
								</div>
							</div>
						<!-- PAGINATION -->
...
<%
	session.removeAttribute("mensaje_afil");
	session.removeAttribute("mensaje_person");
	session.removeAttribute("mensaje_usuar");
	session.removeAttribute("Info_nodo");
	session.removeAttribute("Info_arbol");
	session.removeAttribute("Info_cliente");
	session.removeAttribute("Info_NodoArbol");
%>
</html>