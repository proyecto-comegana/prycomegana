...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina consultar fallo</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del fallo</h2>
				<p>Informaci&oacute;n  del fallo</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CONSULTAR FALLO-->
								<div id="fields">
								      <form:form class="clearfix" method="GET" action="">
								      		<legend>FORMULARIO CONSULTAR FALLO</legend>
          									<table>
              									<tr>
	             									<td><form:label path="iCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="iCodigo" value="${codigo_fallo}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sDescripcion">Descripci&oacute;n: </form:label></td>
                  									<td><form:input size="110" path="sDescripcion" value="${descrip_fallo}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sRuta">Ruta: </form:label></td>
                  									<td><form:input size="110" path="sRuta" value="${ruta_fallo}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sArchivo">Archivo: </form:label></td>
                  									<td><form:input size="110" path="sArchivo" value="${archivo_fallo}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iLinea">L&iacute;nea: </form:label></td>
                  									<td><form:input size="110" path="iLinea" value="${linea_fallo}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_fallo}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_fallo}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
