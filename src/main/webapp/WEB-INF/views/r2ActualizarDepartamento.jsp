...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina respuesta actualizar Departamento</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Visualizaci&oacute;n de los datos del departamento</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
...
<%
	session.removeAttribute("codigo_fallo");
	session.removeAttribute("descrip_fallo");
	session.removeAttribute("ruta_fallo");
	session.removeAttribute("archivo_fallo");
	session.removeAttribute("linea_fallo");
	session.removeAttribute("fecha_fallo");
	session.removeAttribute("hora_fallo");
