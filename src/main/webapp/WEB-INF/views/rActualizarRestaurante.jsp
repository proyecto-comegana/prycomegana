...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina actualizar restaurante</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> de la restaurante</h2>
				<p>Actualice los datos de la restaurante</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO CIUDAD -->
								<div id="fields">
								      <c:url value="/r2ActualizarRestaurante" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO ACTUALIZAR RESTAURANTE</legend>
          									<table>
              									<tr>
	             									<td><form:label path="lCodigo">C&oacute;digo: </form:label></td>
                  									<td><form:input size="110" path="lCodigo" value="${codigo_restaurante}"/></td>
              									</tr>
				
              									<tr>
	             									<td><form:label path="sNombre">Nombre: </form:label></td>
                  									<td><form:input size="110" path="sNombre" value="${nombre_restaurante}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sDescripcion">Descripci&oacute;n: </form:label></td>
                  									<td><form:input size="110" path="sDescripcion" value="${descrip_restaurante}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="sTelefono">Tel&eacute;fono: </form:label></td>
                  									<td><form:input size="110" path="sTelefono" value="${telefono_restaurante}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lPropietario">Propietario: </form:label></td>
                  									<td><form:input size="110" path="lPropietario" value="${propietario_restaurante}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iConvenio">Convenio: </form:label></td>
                  									<td><form:input size="110" path="iConvenio" value="${convenio_restaurante}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iTipo">Tipo: </form:label></td>
                  									<td><form:input size="110" path="iTipo" value="${tipo_restaurante}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sFecha">Fecha: </form:label></td>
                  									<td><form:input size="110" path="sFecha" value="${fecha_restaurante}"/></td>
              									</tr>
              									<tr>
                  									<td><form:label path="sHora">Hora: </form:label></td>
                  									<td><form:input size="110" path="sHora" value="${hora_restaurante}"/></td>
              									</tr>
              									<tr align="center">
                  									<td colspan="2">
