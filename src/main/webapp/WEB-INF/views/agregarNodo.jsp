...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear nodo</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Diligencie los datos del nodo</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								...
								<div id="fields">
									  <c:url value="/rAgregarNodo" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>AGREGAR DATOS DEL NODO</legend>
          									<table>
              									<tr>
                  									<td><form:label path="lCliente">Cliente: </form:label></td>
                  									<td><form:input size="110" path="lCliente" /></td>
              									</tr>
              									<tr>
                  									<td><form:label path="lArbol">&aacute;rbol: </form:label></td>
                  									<td><form:input size="110" path="lArbol" /></td>
              									</tr>
              									<tr>
	             									<td><form:label path="iPosicion">Posici&oacute;n:</form:label></td> 
                  									<td>
                  										<form:select path="iPosicion" style="min-width:780px;height:37px;">
              											<form:option value="0" selected="selected" label="Seleccione una opción"/>
              									...
              									<tr>
	             									<td><form:label path="sEstado">Estado</form:label></td> 
                  									<td>
                  										<form:select path="sEstado" style="min-width:780px;height:37px;">
              											<form:option value="0" selected="selected" label="Seleccione una opción"/>
              									...
              									<tr>
	             									<td><form:label path="iNivel">Niveles</form:label></td> 
                  									<td>
                  										<form:select path="iNivel" style="min-width:780px;height:37px;">
              											<form:option value="0" selected="selected" label="Seleccione una opción"/>
