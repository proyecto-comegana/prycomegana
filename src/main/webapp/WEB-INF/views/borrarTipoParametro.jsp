...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina borrar tipo par&aacute;metro</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				...
				<p>Eliminaci&oacute;n del tipo de par&aacute;metro</p>
			</div>
		</section><!-- //BREADCRUMBS -->
		<!-- BLOG -->
		<section id="blog">
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO BORRAR TIPO DE PARAMETRO -->
								<div id="fields">
									  <c:url value="/rBorrarTipoParametro" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO BORRAR TIPO DE PARAMETRO</legend>
          									<table>
              									<tr>
	             									<td><form:label path="iCodigo">C&eacute;digo: </form:label></td>
