...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina crear nodo y árbol</title>
	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Datos</b> del nodo y el árbol</h2>
				<p>Diligencie los datos del nodo y el árbol</p>
			</div>
		</section><!-- //BREADCRUMBS -->
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<!-- FORMULARIO AGREGAR NODO Y ARBOL -->
								<div id="fields">
									  <c:url value="/rAgregarNodoArbol" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>DATOS DEL NODO Y ARBOL</legend>
          									<table>
              									<tr>
