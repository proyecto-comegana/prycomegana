...
<head>
	<meta charset="utf-8">
	<title>P&aacute;gina actualizar usuario</title>
				...
				<div class="row">
					...
					<div class="blog_block col-lg-9 col-md-9 padbot50">
						...
						<div class="blog_post margbot50 clearfix" data-animated="fadeInUp">
								<div id="fields">
								      <c:url value="/r2ActualizarUsuario" var="formUrl"/>
								      <form:form class="clearfix" method="GET" action="${formUrl}">
								      		<legend>FORMULARIO ACTUALIZAR USUARIO</legend>
          									<table>
              									<tr>
              									...
              									<tr>
	             									<td><form:label path="iTipo">Tipo de usuario: </form:label></td>
                  									<td><form:input size="110" path="iTipo" value="${tipo_usuario}"/></td>
              									</tr>
              									<tr>
	             									<td><form:label path="lPersona">lPersona: </form:label></td>
